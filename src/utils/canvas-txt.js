//Copied from https://npmjs.com/package/canvas-txt / https://github.com/vovastradamus/Canvas-Txt/blob/master/src/index.js (this fork)
...
export default class {
   ...
   * @param {number} height
   */
  drawText(ctx, mytext, x, y, width, height, stroke) {
    ...
    textarray.forEach(txtline => {
      ...
      stroke ? ctx.strokeText(txtline, textanchor, txtY) : ctx.fillText(txtline, textanchor, txtY)
      txtY += charHeight
    })
